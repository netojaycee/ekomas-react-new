...
export const ProductsList = () => {
  ...
  useEffect(() => {
    ...
    if (isTopSelling) {
      filtered = filtered.filter((product) => product.topSelling === true);
    }
  ...
  }, [isSpecialOffersPage, isFeaturedPage, isTopSelling, categoryParam, data]);
      ...
      <div className='pt-[60px]'>
        <div className='w-[80%] mx-auto flex-col flex gap-4 rounded-full'>
          <div className='flex flex-row justify-between text-gray-700'>
            <div>Showing {indexOfFirstProduct + 1}-{indexOfLastProduct} of {filteredProducts.length} results</div>
            <div>
