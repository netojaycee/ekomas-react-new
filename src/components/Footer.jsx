...
const SITEMAP = [
  ...
  },
  {
    ...
    links: [
      ...
      { title: "Terms & Condition", link: "/terms-conditions" },
    ],
  },
  {
    title: "Resources",
...
export default function Footer({ fullFooter = true }) {
      ...
      <div className="bg-gradient-to-r from-primary to-badge flex md:flex-row flex-col items-center  md:gap-5 gap-3 text-white justify-center py-2">
        ...
        <div className="relative flex w-full max-w-[24rem]">
          <Input
            ...
            className="pr-20"
            containerProps={{
              className: "min-w-0 bg-white rounded-[10px] border-none",
            }}
          />
          <Button
            size="sm"
        ...
        {fullFooter ? (
          <>
            ...
            <div className="w-full  bg-gradient-to-r from-secondary to-primary">
              <div className="w-[80%] mx-auto flex flex-col items-center justify-center border-t border-blue-gray-50 py-1 md:flex-row md:justify-between ">
                <img src={logo} alt="logo" />
                <div className="flex gap-4 text-blue-gray-900 md:justify-evenly justify-center">
                  <Typography
                    as="a"
                    href="#"
          ...
          <>
            <div className="w-full bg-primary">
              <div className="w-[80%] mx-auto flex flex-col items-center justify-center border-t border-blue-gray-50 py-2 md:flex-row md:justify-between ">
                <img src={logo} alt="logo" />
                <div className="flex gap-4 text-blue-gray-900 md:justify-evenly justify-center">
                  <Typography
                    as="a"
